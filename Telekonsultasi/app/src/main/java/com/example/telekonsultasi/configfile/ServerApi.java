...
public class ServerApi {
 //     public static final String IPServer="http://macarinaid.wsjti.com/RestApi/";
     // public static final String IPServer="http://192.168.0.20/simrs/Web/api/";
    public static final String IPServer="http://192.168.43.76/simrs/Web/api/";
//      public static final String IPServer="http://192.168.43.254/simrs/Web/api/";
    ...
    public static final String URL_DASHBOARD=IPServer+"Konsul/dashboard";
    ...
    public static final String URL_PASFOTO="http://192.168.43.76/simrs/Web/assets/images/user/";
    public static final String URL_FOTOPASIEN="http://192.168.43.76/simrs/Web/assets/images/pasien/";
