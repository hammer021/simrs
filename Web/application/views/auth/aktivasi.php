        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <div class="text-center card-body" style="margin-top:-50px;">
              <p class="login-card-description">Akun anda telah aktif!</p>
                <a href="#!" class="forgot-password-link">Silahkan Login kembali pada aplikasi telemedicine</a>
            </div>
          </div>
        </div>
      </div>
