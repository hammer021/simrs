		...
		<div class="card">
			...
			<div class="card-content collapse show">
				<div class="body">
					...
					?>
				<form method="post" action="<?= base_url('Profile/update_profiledok') ?>" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<center><img src="<?php echo base_url("assets/images/dokter/" . $prof->image) ?>" width="300px" height="300px">
								<center><br>
						...
						<div class="modal-footer">
							<a class="btn btn-secondary" href="<?php echo base_url('Dokter/dashboard') ?>">Close</a>
