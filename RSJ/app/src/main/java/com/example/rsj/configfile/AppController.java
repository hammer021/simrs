...
public class AppController extends Application {
    private final String TAG = com.example.rsj.configfile.AppController.class.getSimpleName();

    private static com.example.rsj.configfile.AppController instance;

    RequestQueue mRequest;

    public static com.example.rsj.configfile.AppController getInstance() {
        return instance;
    }
